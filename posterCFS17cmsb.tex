...
Influence graph as prior knowledge: reduce the number of possible clauses $S<(2n)^{k+1}$ in \(samples = 2h(S + \log h)\).
...
\item {\bf space-time tradeoff} in line with the pratice of integrative analyses
