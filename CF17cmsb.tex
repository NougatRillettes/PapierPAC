...
Prey -> Prey
   \end{lstlisting}
   \caption{Biocham running the PAC learning algorithm by
   generating 50 random initial states from which a stochastic simulation of
   length 1 is run to obtain samples.}\label{lst:stoch_lv}
\end{listfig}
...
simulations of length 1, all starting from random initial states. Among those
50 initial states, 7 had both prey and predator absent, leading to no sample.
