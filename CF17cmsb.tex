...
\end{definition}
  ...
  $\{0,1\}^n \rightarrow\{0,1\}$ the activation (resp. deactivation) function
  of $x_k$, as the disjunction of the conditions of all positive (resp.
  negative) influences on $x_k$.

  \sylvain{To improve: what is the condition of an influence? can we skip the
