...
the application of PAC learning to dynamical models of biological systems has not been reported before.
...
In the following, these results are first illustrated with a toy example, the Lotka-Volterra prey-predator system as running example,
...
The distinction was kept in this section for the sake of generality.
