...
lymphocyte T, as described by R\'{e}mi, Ruet and Thieffry\cite{RRMTC06tcsb}.

\begin{example}
   \sylvain{I will add some introductory text here to present the example}\label{ex:lympho}

   \begin{figure}[htbp]
      \includegraphics[width=\textwidth]{./PresSeminar/th_net.png}
      \caption{The Th lymphocyte differentiation model
      of~\cite{RRMTC06tcsb}.\label{fig:lympho}}
   \end{figure}
