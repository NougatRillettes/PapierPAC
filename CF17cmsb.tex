...
\begin{definition}
   ...
   and $n$ boolean functions $\{f_1,\dots,f_n\}$\dots
\end{definition}
...
\sylvain{%
  ...
  Indeed in that formalism, given a network of $n$ genes $x_1,\ldots,x_n$, and an integer $1 \leq k \leq n$ we can define ${x_k}_+$ (resp. ${x_k}_-$): $\{0,1\}^n \rightarrow\{0,1\}$ the activation (resp. deactivation) function of $x_k$.
