...
Fig.~\ref{fig:statistics}. Interestingly, the minimal number of samples gives us the lowest
$L(h, S)$ and thus quasi-linearly the lowest guarantee $h$.

\begin{figure}[htb]
   \includegraphics[width=\textwidth]{statistics/statistics.png}
   \caption{Standard deviation, minimum number of
   samples, and error obtained in the simulations for the 24 boolean functions of the Th-lymphocyte example, as a function of the number of initial states. The
minimum gives a quasi-linear estimate of the model confidence $h$. The total 
%(and therefore the average) 
number of samples is kept constant by adjusting the
time horizon of the simulations. Obviously, more diverse initial states %, (e.g., mutants) 
...
due to the complexity of the models learnt with traces from only 10 to 100 initial states. }%
...
This work was partly supported by the ANR project Hyclock.
